...
<body>
    <nav class="navbar navbar-expand-xl navbar-light bg-light">
        ...
        <a href="../" class="navbar-brand"> Stud<b>dict</b></a>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse ">
            <div class="navbar-nav">
                ...
                <a href="materi.php" class="nav-item nav-link">Materi</a> -->
                <a href="testimoni.php" class="nav-item nav-link">Testimoni</a>
                <a href="upgrade.php" class="nav-item nav-link">Upgrade</a>
                <!-- <a href="userlist.php" class="nav-item nav-link">Daftar User</a> -->
			...
			<a href="#" class="nav-item nav-link messages"><i class="fa fa-envelope-o"></i><span class="badge">10</span></a></a> -->
                <div class="nav-item dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action">
                        <?php echo $email ?> <b class="caret"></b></a>
                    <div class="dropdown-menu">
                        <a href="#" class="dropdown-item"><i class="fa fa-user"></i> Profile</a></a>
                        ...
                        <a href="../loginsystem/logout.php" class="dropdown-item"><i class="material-icons">&#xE8AC;</i>
                            Logout</a></a>
                    </div>
                </div>
            </div>
