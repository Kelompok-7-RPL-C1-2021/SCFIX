            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        ';
                        if($validasi == 1){
                            echo '<a href="valtestimoni.php?id='. $id_feedback .'"> <button type="submit" class="btn btn-primary btn-sm" name="test">Tampilkan</button></a>';
                        }
                        else if($validasi == 2){
                            echo '<a href="valtestimoni.php?id='. $id_feedback .'"> <button type="submit" class="btn btn-warning btn-sm" name="test">Sembunyikan</button></a>';
                        } 
                        echo'
                        </td>
                    </tr>';
